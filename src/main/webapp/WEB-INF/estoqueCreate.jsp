            ...
            <div class="row">
                <form name="form-estoque" action="#" method="POST" class="col s12" accept-charset="UTF-8">
                    <div class="row">
                        ...
                        <div class="input-field col12 s12 m12 l4">
                            <label for="imagens">Imagens do Jogo</label>
                            <input name="imagens" id="imagens" type="text" class="validate" required="required" placeholder="Insira os Links Separados por ;">
                        </div>
                        ...
                        <div class="input-field col12 s12 m12 l4">
                            ...
                            <input name="descricao_curta" id="descricao_curta" type="text" class="validate" required="required">
                            <br/>
                        </div>
