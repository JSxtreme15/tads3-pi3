                ...
                <form name="form-fornecedores" action="#" method="POST" class="col s12" accept-charset="UTF-8">
                    <div class="row">
                        ...
                        <div class="input-field col s12 m12 l4">
                            ...
                            <input name="desenvolv" id="desenvolv" type="text" class="validate" required="required" value="${estoque.getDesenvolvedora()}">
                        </div>

                        <div class="input-field col s12 m6 l6">
                            <label for="plataforma">Console</label>
                            <input name="console" id="console" type="text" class="validate" required="required"  value="${estoque.getPlataforma()}">
                        </div>

                        <div class="input-field col s12 m6 l6">
                            <label for="quantidade">Quant. Estoque</label>
                            <input name="quantEstoque" id="quantEstoque" type="text" class="validate" required="required" value="${estoque.getQuantidade()}">
                        </div>
