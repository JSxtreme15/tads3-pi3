            ...
            <div class="container">
                <div class="nav-wrapper">
                    <div class="col s12">
                        ...
                        <a href="${pageContext.request.contextPath}/clientes/atualizar?id=${cliente.getId()}" class="breadcrumb">Cadastro de Clientes</a>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <form name="form-clientes" action="#" method="POST" class="col s12" accept-charset="UTF-8">
                    <div class="row">
                        ...
                        <div class="input-field right">
                            ...
                            <button type="submit" class="waves-effect waves-light btn"><i class="material-icons left">send</i> Editar</button>
                        </div>
                    </div>
                </form>
            </div>
