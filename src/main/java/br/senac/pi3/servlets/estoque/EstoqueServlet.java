...
public class EstoqueServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        EstoqueEntidade estoque12 = new EstoqueEntidade("9168486", "Rainbow Six Siege","129.9","UBISOFT","Play Station 4","400");
        EstoqueEntidade estoque13 = new EstoqueEntidade("9370771","Fifa 17","149.9","EA Sports","Xbox One","400");
        EstoqueEntidade estoque14 = new EstoqueEntidade("9369461","The Witcher III","129.9","CD Projekt RED","Xbox One","400");
        EstoqueEntidade estoque15 = new EstoqueEntidade("9319839","Overwatch","199.9","Blizzard","Xbox One","500");
        EstoqueEntidade estoque16 = new EstoqueEntidade("9416811","Ghost Recon","149.9","UBISOFT","Xbox One","200");
        EstoqueEntidade estoque17 = new EstoqueEntidade("9384447","Watch Dogs 2","149.9","UBISOFT","Xbox One","200");
        EstoqueEntidade estoque18 = new EstoqueEntidade("9479054","Dark Souls III","199.9","Bandai Namco","Xbox One","200");
        EstoqueEntidade estoque19 = new EstoqueEntidade("9414777","For Honnor","159.9","UBISOFT","Xbox One","400");
        EstoqueEntidade estoque20 = new EstoqueEntidade("9487967","Injuntice 2","249.9","NetherRealm Studios","Xbox One","400");
        EstoqueEntidade estoque21 = new EstoqueEntidade("9369420","Gears of War 4","99.9","The Coalition","Xbox One","200");
        EstoqueEntidade estoque22 = new EstoqueEntidade("9351269","Final Fantasy XV","249.9","Squarce Enix","Xbox One","500");
        EstoqueEntidade estoque23 = new EstoqueEntidade("9280736","Mortal Kombat XL","129.9","NetherRealm Studios","Xbox One","200");
        EstoqueEntidade estoque24 = new EstoqueEntidade("9395590","Resident Evil 7","219.9","CAPCOM","Xbox One","500");
        EstoqueEntidade estoque25 = new EstoqueEntidade("9258976","The Division","99.9","UBISOFT","Xbox One","200");
        EstoqueEntidade estoque26 = new EstoqueEntidade("9153641","Just Dance 2017","149.9","UBISOFT","Xbox One","400");
        EstoqueEntidade estoque27 = new EstoqueEntidade("9380186", "Titanfall 2", "149.9", "EA Sports", "Xbox One", "400");
